...
public class ProdutoEditar extends javax.swing.JInternalFrame {
    ...
    private void buscarProduto(){
        ...
        for(int i=0;i<resultado.size(); i++){
            ...
            linha.add(resultado.get(i).getQuantidade());
            ...
            linha.add(resultado.get(i).getEstoque().getQuantidade());
            linha.add(resultado.get(i).getEstoque().getQuantidadeMinimaDesejada());
            linha.add(Util.getStringDateFromCalendar(resultado.get(i).getEstoque().getDataAquisicao()));
            linha.add(Util.getStringDateFromCalendar(resultado.get(i).getEstoque().getDataValidade()));
            modelo.addRow(linha);
        }
