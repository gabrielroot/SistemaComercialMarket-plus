...
public class TelaClienteEditar extends javax.swing.JInternalFrame {
    ...
    private boolean getComponentes(){
        ...
        if(this.txtTelefone1.getValue() != null){
            Telefone telefone1 = new Telefone(util.getNumeroTelefoneSemFormatacao(this.txtTelefone1.getValue().toString()) );
            telefones.add(telefone1);
        }
        
        if(this.txtTelefone2.getValue() != null){
            Telefone telefone2 = new Telefone(util.getNumeroTelefoneSemFormatacao(this.txtTelefone2.getValue().toString()) );
